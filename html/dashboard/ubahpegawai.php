...
if (isset($_POST['txtnip'])) {
  ...
  $departemen = $_POST['txtdepartemen'];

  $sqll = "UPDATE pegawai SET nama='$nama', jenkel='$jenkel', lahir='$lahir', hp='$hp',departemen='$departemen' WHERE nip='$nipn'";
            ...
            <div class="card-body">
              <form action="" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtnip" id="nip" value="<?php echo
                                                                                        $isi['nip']; ?>" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtjabatan" id="jabatan" value="<?php echo
                                                                                      $isi['jabatan']; ?>">
                </div>

                <div class="form-group">
                  <label for="departemen" class="form-label">departemen</label>
                  <select class="form-select" aria-label="Default select example" name="txtdepartemen" id="departemen">
                    <?php
                    if ($isi['departemen'] == "Keuangan") {
                      echo '<option selected value="Keuangan">Keuangan</option>';
                      echo '<option value="Keamanan">Keamanan</option>';
                      echo '<option value="Kebersihan">Kebersihan</option>';
                    } else if ($isi['departemen'] == "Keamanan") {
                      echo '<option value="Keuangan">Keuangan</option>';
                      echo '<option selected value="Keamanan">Keamanan</option>';
                      echo '<option value="Kebersihan">Kebersihan</option>';
                    } else {
                      echo '<option value="Keuangan">Keuangan</option>';
                      echo '<option value="Keamanan">Keamanan</option>';
                      echo '<option selected value="Kebersihan">Kebersihan</option>';
                    }
                    ?>
                  </select>
                </div>
