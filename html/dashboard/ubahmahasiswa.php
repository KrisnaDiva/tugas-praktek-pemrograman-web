...
if (isset($_POST['txtnim'])) {
  ...
  $sqll = "UPDATE mahasiswa SET nama='$nama', jenkel='$jenkel', lahir='$lahir', hp='$hp',jurusan='$jurusan' WHERE nim='$nimm'";
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Mahasiswa / <h4 style="font-weight: 700;display: inline-block;">Ubah Data</h4></label>
            </div>
            ...
            <div class="card-body">
              <form action="" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtnim" id="nim" value="<?php echo
                                                                                        $isi['nim']; ?>" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-select" aria-label="Default select example" name="txtjurusan" id="jurusan">
                    <?php
                    if ($isi['jurusan'] == "Teknik Informatika") {
                      echo '<option selected value="Teknik Informatika">Teknik Informatika</option>';
                      echo '<option value="Sistem Informasi">Sistem Informasi</option>';
                      echo '<option value="Pendidikan Teknologi Informasi">Pendidikan Teknologi Informasi</option>';
                    } else if ($isi['jurusan'] == "Sistem Informasi") {
                      echo '<option value="Teknik Informatika">Teknik Informatika</option>';
                      echo '<option selected value="Sistem Informasi">Sistem Informasi</option>';
                      echo '<option value="Pendidikan Teknologi Informasi">Pendidikan Teknologi Informasi</option>';
                    } else {
                      echo '<option value="Teknik Informatika">Teknik Informatika</option>';
                      echo '<option value="Sistem Informasi">Sistem Informasi</option>';
                      echo '<option selected value="Pendidikan Teknologi Informasi">Pendidikan Teknologi Informasi</option>';
                    }
                    ?>
                  </select>
                </div>
