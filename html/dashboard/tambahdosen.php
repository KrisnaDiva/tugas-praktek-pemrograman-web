...
if (isset($_POST['txtnidn'])) {
  ...
  $sql = "insert into dosen values('$nidn','$nama','$jenkel','$lahir','$hp','$status')";
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-dose" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../dashboard/tambahdosen.php">
                <i class="fa fa-plus" style="width: 14px;height: 16px;">
                  </i>
                  <span class="item-name">Tambah Data</span>
                </a>
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Dosen / <h4 style="font-weight: 700;display: inline-block;">Tambah Data</h4></label>
            </div>
            ...
            <div class="card-body">
              <form action="" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtnidn" id="nidn" placeholder="Masukkan NIDN">
                </div>
                <div class="form-group">
