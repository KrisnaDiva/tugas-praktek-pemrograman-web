      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Admin / <h4 style="font-weight: 700;display: inline-block;">Data</h4></label>
            </div>
          ...
          <div class="card" style="margin-top: 5rem;">
            ...
            <div class="card-body">
              ...
              <form action="" method="post">
                <div class="row align-items-center">
                  <div class="col-md-6 col-sm-12 text-lg-start text-md-start">
                    <!-- <label for="semester">Pilih Role : </label>
                    <select id="role" class="form-select" name="role" onchange="this.form.submit()" style="width: auto;display:inline;">
                      <option value="all" <?php if ($role == 'all') echo 'selected'; ?>>Semua Role</option>
                      <option value="Admin" <?php if ($role == 'Admin') echo 'selected'; ?>>Admin</option>
                      <option value="Admin Mahasiswa" <?php if ($role == 'Admin Mahasiswa') echo 'selected'; ?>>Admin Mahasiswa</option>
                      <option value="Admin Dosen" <?php if ($role == 'Admin Dosen') echo 'selected'; ?>>Admin Dosen
                      </option>
                      <option value="Admin Pegawai" <?php if ($role == 'Admin Pegawai') echo 'selected'; ?>>Admin Pegawai
                      </option>
                    </select> -->
                  </div>
                  <div class="col-md-6 col-sm-12 text-lg-end text-md-start">
                    <label for="username">Cari : </label>
                    <input type="text" class="form-control form-control-sm" id="username" name="username" placeholder="Masukkan Username" style="width: auto;display:inline;">

                    <button type="submit" class="btn btn-primary btn-auto"><i class=" fa fa-search"></i></button>
                    <a type="button" class="btn btn-danger btn-auto" href="admin.php"><i class=" fa fa-x"></i></a>
                  </div>
                </div>
              ...
              <div class="table-responsive">
                <table id="datatable" class="table table-striped table-bordered" data-toggle="table-ascdesc">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Username</th>
                  ...
                  <tbody>
                    ...
                    $proses = mysqli_query($koneksi, "select * from admin $where limit $halaman_awal, $batas");
                    ...
                    while ($isi = mysqli_fetch_assoc($proses)) : ?>
                      <tr>
                        ...
                        <td><img src="gambar/<?php echo $isi['foto'] ?>" width="40"></td>
