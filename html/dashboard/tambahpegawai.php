...
if (isset($_POST['txtnip'])) {
  ...
  $sql = "insert into pegawai values('$nip','$nama','$jenkel','$lahir','$hp','$jabatan','$departemen')";
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-pega" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../dashboard/tambahpegawai.php">
                <i class="fa fa-plus" style="width: 14px;height: 16px;">
                  </i>
                  <span class="item-name">Tambah Data</span>
                </a>
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Pegawai / <h4 style="font-weight: 700;display: inline-block;">Tambah Data</h4></label>
            </div>
            ...
            <div class="card-body">
              <form action="" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtnip" id="nip" placeholder="Masukkan NIP">
                </div>
                <div class="form-group">
                  <label for="nama" class="form-label">Nama</label>
                  <input type="text" class="form-control" name="txtnama" id="nama" placeholder="Masukkan Nama">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txthp" id="hp" placeholder="Masukkan No HP">
                </div>
                <div class="form-group">
                  <label for="jabatan" class="form-label">Jabatan</label>
                  <input type="text" class="form-control" name="txtjabatan" id="jabatan" placeholder="Masukkan Jabatan">
                </div>
                <div class="form-group">
