...
if (isset($_POST['txtnim'])) {
  ...
  $sql = "insert into mahasiswa values('$nim','$nama','$jenkel','$lahir','$hp','$jurusan')";
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-maha" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../dashboard/tambahmahasiswa.php">
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Mahasiswa / <h4 style="font-weight: 700;display: inline-block;">Tambah Data</h4></label>
            </div>
            ...
            <div class="card-body">
              <form action="" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtnim" id="nim" placeholder="Masukkan NIM">
                </div>
                <div class="form-group">
