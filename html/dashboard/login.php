                        ...
                        <div class="card-body">
                           ...
                           <form action="" method="post">
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <input type="username" class="form-control" id="username" aria-describedby="username" placeholder=" " name="username">
                                    </div>
                                 </div>
                                 <div class="col-lg-12">
                                    <div class="form-group">
                              ...
                              <p class="mt-3 text-center">
                                 Belum Punya Akun? <a href="register.php" class="text-underline">Klik Disini Untuk Register</a>
                              </p>
                           </form>
                        </div>
                     </div>
