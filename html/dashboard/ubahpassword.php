...
if (isset($_POST['pwl'])) {
    $pwl = $_POST['pwl'];
    $pwb = $_POST['pwb'];
    $sql = "UPDATE admin SET password='$pwb' WHERE username = '" . $_SESSION['username'] . "'";
    if($pwl==$isi['password']){
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;"><h4 style="font-weight: 700;display: inline-block;">Ubah Password</h4></label>
            </div>
            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <li>
                  ...
                  <li><a class="dropdown-item active" href="ubahpassword.php">Ubah Password</a></li>
                  <li>
                    <hr class="dropdown-divider">
                  </li>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-sm-5 ">
          <div class="card" style="margin-top: 5rem;">
            ...
            <div class="card-body">
            <?php if (isset($gantiError) && $gantiError) { ?>
              ...
              <form action=" " method="post" enctype="multipart/form-data" >
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="pwl" required="required" id="pwl">
                </div>

                <div class="form-group">
                  <label for="pwb" class="form-label">Password Baru</label>
                  <input type="text" class="form-control" name="pwb" required="required" id="pwb">
                </div>
