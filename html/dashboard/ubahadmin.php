...
if (isset($_POST['username'])) {
  ...
  // Perform validation and sanitization of user input, if needed
  ...
  //   mysqli_query($koneksi, "UPDATE admin SET jenkel='$jenkel', lahir='$lahir', hp='$hp', foto='$xx' WHERE username='$username'");
  // } else {
  //   // Update data without changing the image
  //   mysqli_query($koneksi, "UPDATE admin SET jenkel='$jenkel', lahir='$lahir', hp='$hp', email='$email' WHERE username='$username'");
  // }
  $sqlad = "UPDATE admin SET jenkel='$jenkel', lahir='$lahir', hp='$hp', email='$email' WHERE username='$username'";
  $prosesad = mysqli_query($koneksi, $sqlad);
  if($prosesad){
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Profil /  <h4 style="font-weight: 700;display: inline-block;">Ubah Data</h4></label>
            </div>
            ...
            <div class="card-body">
              <form action=" " method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="username" required="required" id="usr" value="<?php echo
                                                                                                              $isi['username']; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtemail" id="email" value="<?php echo
                                                                                      $isi['email']; ?>">
                </div>
                <!-- <div class="form-group">
                  ...
                  <?php
                  if (!empty($isi['foto'])) {
                    echo '<p>Foto saat ini: ' . $isi['foto'] . '</p>';
                  }
                  ?>
                </div> -->
