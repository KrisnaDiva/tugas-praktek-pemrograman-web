...
if (isset($_POST['jurusan'])) {
  ...
  $_SESSION['jurusan'] = $jurusan; // Simpan jurusan dalam session
  $halaman = 1;
} elseif (isset($_SESSION['jurusan'])) {
  $jurusan = $_SESSION['jurusan']; // Gunakan jurusan dari session jika sudah disimpan sebelumnya
} else {
  $jurusan = 'all';
}
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-maha" data-bs-parent="#sidebar-menu">
              <li class="nav-item">
                <a class="nav-link active" href="../dashboard/mahasiswa.php">
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px; ">Mahasiswa / <h4 style="font-weight: 700;display: inline-block;">Data</h4></label>
            </div>
          ...
          <div class="card" style="margin-top: 5rem;">
            ...
            <div class="card-body">
              <form action="" method="post">
                <div class="row align-items-center">
                  <div class="col-md-6 col-sm-12 text-lg-start text-md-start">
                    ...
                    <select id="jurusan" class="form-select" name="jurusan" onchange="this.form.submit()" style="width: auto;display:inline;">
                      <option value="all" <?php if ($jurusan == 'all') echo 'selected'; ?>>Semua Jurusan</option>
                      ...
                      <option value="Pendidikan Teknologi Informasi" <?php if ($jurusan == 'Pendidikan Teknologi Informasi') echo 'selected'; ?>>Pendidikan Teknologi Informasi
                    </select>
                  </div>
                  <div class="col-md-6 col-sm-12 text-lg-end text-md-start">
                    <label for="nim">Cari : </label>
                    <input type="text" class="form-control form-control-sm" id="nim" name="nim" placeholder="Masukkan NIM atau nama" style="width: auto;display:inline;">

                    <button type="submit" class="btn btn-primary btn-auto"><i class=" fa fa-search"></i></button>
                    <a type="button" class="btn btn-danger btn-auto" href="mahasiswa.php"><i class=" fa fa-x"></i></a>
              ...
              <div class="table-responsive">
                <table id="datatables" class="table table-striped table-bordered" data-toggle="table-ascdesc">
                  ...
                  <tbody>
                    ...
                    if (!empty($nim)) {
                      ...
                      $where = "WHERE nim like '%".$nim."%' or nama like '%".$nim."%'";
                    }
                    $batas = 5;
                    ...
                    $proses = mysqli_query($koneksi, "SELECT * FROM mahasiswa $where LIMIT $halaman_awal, $batas");
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a type="button" class="btn btn-primary" href="ubahmahasiswa.php?x=<?php echo $isi['nim'] ?>"><i class='fa fa-edit'></i></a>
                          <a type="button" class="btn btn-danger" href="hapusmahasiswa.php?x=<?php echo $isi['nim']; ?>"><i class='fa fa-trash'></i></a>
                        </td>
                      </tr>
                    <?php
                    endwhile;
                ...
                <a type="button" class="btn btn-success" href="tambahmahasiswa.php">Tambah Mahasiswa</a>
              </div>
            </div>
          </div>
        </div>
