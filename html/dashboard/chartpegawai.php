...
session_start();
include("koneksi.php");
$sqlz = "SELECT departemen, COUNT(*) as tod FROM pegawai GROUP BY departemen";
$resultz = $koneksi->query($sqlz);
...
if ($resultz->num_rows > 0) {
  ...
  while ($rowz = $resultz->fetch_assoc()) {
    $labelsz[] = $rowz["departemen"];
    $dataz[] = $rowz["tod"];
  }
}

// Query untuk mendapatkan jumlah keseluruhan Admin
$totalPegawai = array_sum($dataz);
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-pega" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../dashboard/chartpegawai.php">
  ...
  <main class="main-content">
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Pegawai / <h4 style="font-weight: 700;display: inline-block;">Statistik</h4></label>
            </div>
    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
      ...
      <div class="col-md-8 col-xl-8">
        ...
        <div class="col-md-4 col-xl-4" data-aos="fade-up">
          <div class="card"data-aos="fade-up" data-aos-delay="1000">
            <div class="flex-wrap card-header d-flex justify-content-between">
              <div class="header-title">
                <h4 class="card-title">Pegawai</h4>
...
<script>
  var ctxx = document.getElementById("myChartt").getContext('2d');
    var myChartt = new Chart(ctxx, {
      type: 'bar',
      data: {
        labels: ["Keuangan", "Keamanan", "Kebersihan"],
        datasets: [{
          label: 'Data',
          data: [
            <?php
            $jumlah_ti = mysqli_query($koneksi, "select * from pegawai where departemen='Keuangan'");
            echo mysqli_num_rows($jumlah_ti);
            ?>,
            <?php
            $jumlah_si = mysqli_query($koneksi, "select * from pegawai where departemen='Keamanan'");
            echo mysqli_num_rows($jumlah_si);
            ?>,
            <?php
            $jumlah_pti = mysqli_query($koneksi, "select * from pegawai where departemen='Kebersihan'");
    ...
    const ctz = document.getElementById('persenadm').getContext('2d');
    const myChartz = new Chart(ctz, {
      type: 'doughnut',
      data: {
        labels: <?php echo json_encode($labelsz); ?>,
        datasets: [{
          label: 'Jumlah Dosen',
          data: <?php echo json_encode($dataz); ?>,
          backgroundColor: [
            'rgba(255, 99, 132, 0.6)',
            'rgba(54, 162, 235, 0.6)',
            'rgba(255, 206, 86, 0.6)'
          ...
          tooltip: {
            callbacks: {
              label: function(context) {
                ...
                var percentage = (value / <?php echo $totalPegawai; ?> * 100).toFixed(2);
