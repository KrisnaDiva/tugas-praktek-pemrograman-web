...
if (isset($_POST['submit'])) {
  ...
  // Melakukan proses insert ke dalam tabel matakuliah (disesuaikan dengan konfigurasi database Anda)
  ...
  $sql = "INSERT INTO tb_matkul (kmk, namamatkul, sks, semester) VALUES ";

  foreach ($inputs as $inputValues) {
      $kmk = $inputValues[0];
      $namamatkul = $inputValues[1];
      $sks = $inputValues[2];
      $semester = $inputValues[3];
      $sql .= "('$kmk', '$namamatkul', '$sks', '$semester'), ";
  }

  // Menghapus koma dan spasi terakhir dari query
  $sql = rtrim($sql, ", ");
...
<body class="  ">
  ...
  <main class="main-content">
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Admin / <h4 style="font-weight: 700;display: inline-block;">Tambah Data</h4></label>
            </div>
    ...
    <form method="POST" action="">
        ...
        <label for="quantity">Jumlah Angka:</label>
        <input type="number" id="quantity" name="quantity" min="1" max="10">
        <br><br>
        <button type="button"  class="btn btn-success" onclick="generateInputs()">Buat Input</button>
        <br><br>
