...
session_start();
include("koneksi.php");
$sqlz = "SELECT status, COUNT(*) as tod FROM dosen GROUP BY status";
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-dose" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../dashboard/chartdosen.php">
                <i class="fa fa-chart-line" style="width: 14px;height: 16px;">
                  </i>
                  <span class="item-name">Statistik</span>
                </a>
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-admin" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link " href="../dashboard/tambahadmin.php">
                <i class="fa fa-plus" style="width: 14px;height: 16px;">
                  </i>
                  <span class="item-name">Tambah Data</span>
                </a>
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Dosen / <h4 style="font-weight: 700;display: inline-block;">Statistik</h4></label>
            </div>
    ...
    var myChartt = new Chart(ctxx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [
            <?php
            $jumlah_ti = mysqli_query($koneksi, "select * from dosen where status='Dosen Tetap'");
            echo mysqli_num_rows($jumlah_ti);
            ?>,
            <?php
            $jumlah_si = mysqli_query($koneksi, "select * from dosen where status='Dosen Tidak Tetap'");
            echo mysqli_num_rows($jumlah_si);
            ?>,
            <?php
            $jumlah_pti = mysqli_query($koneksi, "select * from dosen where status='Dosen Honorer'");
          ...
          tooltip: {
            callbacks: {
              label: function(context) {
                ...
                var percentage = (value / <?php echo $totalDosen; ?> * 100).toFixed(2);
