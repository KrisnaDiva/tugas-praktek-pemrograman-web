...
session_start();
include("koneksi.php");
$sqql = "SELECT jurusan, COUNT(*) as total FROM mahasiswa GROUP BY jurusan";
$result = $koneksi->query($sqql);
...
// Query untuk mendapatkan jumlah keseluruhan mahasiswa
$totalMahasiswa = array_sum($dataa);
?>
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-maha" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../dashboard/chartmahasiswa.php">
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Mahasiswa / <h4 style="font-weight: 700;display: inline-block;">Statistik</h4></label>
            </div>
...
<script>
  var ctxx = document.getElementById("myChartt").getContext('2d');
    var myChartt = new Chart(ctxx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [
            <?php
            $jumlah_ti = mysqli_query($koneksi, "select * from mahasiswa where jurusan='Teknik Informatika'");
            echo mysqli_num_rows($jumlah_ti);
            ?>,
            <?php
            $jumlah_si = mysqli_query($koneksi, "select * from mahasiswa where jurusan='Sistem Informasi'");
            echo mysqli_num_rows($jumlah_si);
            ?>,
            <?php
            $jumlah_pti = mysqli_query($koneksi, "select * from mahasiswa where jurusan='Pendidikan Teknologi Informasi'");
    ...
    const cttx = document.getElementById('persenadm').getContext('2d');
    const myCChart = new Chart(cttx, {
      type: 'doughnut',
      data: {
          ...
          tooltip: {
            callbacks: {
              label: function(context) {
                ...
                var percentage = (value / <?php echo $totalMahasiswa; ?> * 100).toFixed(2);
