...
if (isset($_POST['departemen'])) {
  ...
  $_SESSION['departemen'] = $departemen; // Simpan departemen dalam session
  $halaman = 1;
} elseif (isset($_SESSION['departemen'])) {
  $departemen = $_SESSION['departemen']; // Gunakan departemen dari session jika sudah disimpan sebelumnya
} else {
  $departemen = 'all';
}
...
$where = '';
if ($departemen !== 'all') {
  $where = "WHERE departemen='$departemen'";
}
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-pega" data-bs-parent="#sidebar-menu">
              <li class="nav-item">
                <a class="nav-link active" href="../dashboard/pegawai.php">
                  <i class="fa fa-file-lines" style="width: 14px;height: 16px;">
                  </i>
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <div class="input-group search-input">
              <label style="font-size: 20px;">Pegawai / <h4 style="font-weight: 700;display: inline-block;">Data</h4></label>
            </div>
            ...
            <div class="card-body">
              <form action="" method="post">
                <div class="row align-items-center">
                  <div class="col-md-6 col-sm-12 text-lg-start text-md-start">
                    <label for="departemen">Pilih Departemen : </label>
                    <select id="departemen" class="form-select" name="departemen" onchange="this.form.submit()" style="width: auto;display:inline;">
                      <option value="all" <?php if ($departemen == 'all') echo 'selected'; ?>>Semua Departemen</option>
                      <option value="Keuangan" <?php if ($departemen == 'Keuangan') echo 'selected'; ?>>Keuangan</option>
                      <option value="Keamanan" <?php if ($departemen == 'Keamanan') echo 'selected'; ?>>Keamanan</option>
                      <option value="Kebersihan" <?php if ($departemen == 'Kebersihan') echo 'selected'; ?>>Kebersihan
                    </select>
                  </div>
                  <div class="col-md-6 col-sm-12 text-lg-end text-md-start">
                    <label for="nip">Cari : </label>
                    <input type="text" class="form-control form-control-sm" id="nip" name="nip" placeholder="Masukkan NIP atau Nama" style="width: auto;display:inline;">

                    <button type="submit" class="btn btn-primary btn-auto"><i class=" fa fa-search"></i></button>
                    <a type="button" class="btn btn-danger btn-auto" href="pegawai.php"><i class=" fa fa-x"></i></a>
              ...
              <div class="table-responsive">
                <table id="datatables" class="table table-striped table-bordered" data-toggle="table-ascdesc">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>NIP</th>
                  ...
                  <tbody>
                    ...
                    if (!empty($nip)) {
                      $where = "WHERE nip like '%".$nip."%' or nama like '%".$nip."%'";
                    ...
                    $data = mysqli_query($koneksi, "SELECT * FROM pegawai $where");
                    ...
                    $proses = mysqli_query($koneksi, "SELECT * FROM pegawai $where LIMIT $halaman_awal, $batas");
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a type="button" class="btn btn-primary" href="ubahpegawai.php?x=<?php echo $isi['nip'] ?>"><i class='fa fa-edit'></i></a>
                          <a type="button" class="btn btn-danger" href="hapuspegawai.php?x=<?php echo $isi['nip']; ?>"><i class='fa fa-trash'></i></a>
                        </td>
                      </tr>
                    <?php
                    endwhile;
                ...
                <a type="button" class="btn btn-success" href="tambahpegawai.php">Tambah Pegawai</a>
              </div>
            </div>
          </div>
        </div>
